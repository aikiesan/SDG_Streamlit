...
<style>
    ...
    .stApp {{ 
        ...
        color: var(--text-primary); /* Default text color for the entire app */
    }}
    ...
    .stCheckbox > div > div > label {{
        ...
        color: var(--text-primary); /* Set base text color for the label itself */
    }}
    ...
    /* Ensure text WITHIN radio/checkbox options is clearly visible */
    .stRadio > div > label span[data-baseweb="typo-labelmedium"],
    .stCheckbox > div > div > label span[data-baseweb="checkbox"] > div:last-child {{
        color: var(--text-primary) !important; /* Dark text on light option background */
    ...
    .stAlert ul, .stAlert li {{
        color: inherit !important; /* Try to let Streamlit handle contrast based on alert type */
    }}

    /* Text inside stMetric components */
    .stMetric > div > div > label[data-testid="stMetricLabel"] {{
        color: var(--text-secondary) !important; /* Muted/secondary color for label */
    }}
    
    .stMetric div[data-testid="stMetricValue"] {{
        color: var(--text-primary) !important; /* Primary color for the value */
    }}
