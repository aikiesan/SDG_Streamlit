...
<style>
    ...
    .question-card:empty,
    .question-card:blank,
    .stMarkdown:has(.question-card:empty),
    .stMarkdown:has(.question-card:blank),
    .st-emotion-cache-mxeqmx:has(.question-card:empty),
    .st-emotion-cache-mxeqmx:has(.question-card:blank),
    .stMarkdownContainer:has(.question-card:empty),
    .stMarkdownContainer:has(.question-card:blank) {
    ...
    /* Remove extra spacing between questions */
...
def render_questions():
    ...
    for q in questions:
        # Start the question card container
        ...
        # Close the question card container
